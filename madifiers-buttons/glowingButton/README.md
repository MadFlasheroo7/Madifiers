...
![Maven Central](https://img.shields.io/maven-central/v/pro.jayeshseth.madifiers/glowingButton?style=flat-square)
...
```kotlin
dependencies {
    implementation("pro.jayeshseth.madifiers:glowingButton:<version>")
}
```
